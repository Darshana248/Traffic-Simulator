...
type Edge<Node = unknown, Props = unknown> = {
    source: Node;
    target: Node;
    weight?: EdgeWeight;
    props: Props;
};
type Serialized<Node = unknown, LinkProps = unknown> = {
    nodes: Node[];
 ...
 */
declare function shortestPath<Node, LinkProps>(graph: Graph<Node, LinkProps>, source: NoInfer<Node>, destination: NoInfer<Node>): {
    nodes: [
        Node,
        Node,
        ...Node[]
 ...
 * @param opts
 */
declare function serializeGraph<Node, LinkProps, IncludeDefaultWeight extends boolean>(graph: Graph<Node, LinkProps>, opts?: SerializeGraphOptions<IncludeDefaultWeight>): Serialized<Node, LinkProps>;
declare function deserializeGraph<Node, LinkProps, NodeIdentity>(...args: NodeIdentity extends object ? [
    data: SerializedInput<NodeIdentity, LinkProps>,
    identityFn: (node: NoInfer<NodeIdentity>) => NodeIdentity
] : [
    data: SerializedInput<NodeIdentity, LinkProps>
]): Graph<NodeIdentity, LinkProps>;
/**
...
export type { Edge, Serialized, SerializedInput, EdgeWeight };
export { Graph, CycleError, depthFirstSearch, shortestPath, shortestPaths, topologicalSort, lowestCommonAncestors, indegree, outdegree, cloneGraph, hasCycle, serializeGraph, deserializeGraph, findNodes, getNode, getFirstNode };
